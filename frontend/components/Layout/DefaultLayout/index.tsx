    ...
    <div className={classsName}>
      ...
      <aside className="h-screen w-18 border-r border-gray-200 bg-white flex flex-col items-center">
        ...
        <nav className="flex flex-1 flex-col gap-y-4 pt-18">
          <a
            className="group relative rounded-xl p-2 text-blue-600 bg-gray-100"
            href="#"
          >
      ...
      <div className="flex h-screen flex-1 flex-col">
        ...
        <main className="flex-1 overflow-y-auto px-12">
          <div className="my-12 bg-white"></div>
        </main>
      </div>

      {/* Right Panel  */}
      <aside className="h-screen w-[300px] flex flex-col bg-white border-gray-200 border-l">
